 ...
 * 
 * This class selects {@link NrmlMemModelUnitVecExtItr#compareVecCount} vectors
 ...
 * {@link NrmlMemModelUnitVecExtItr#comparisonVecs} to narrow down the search of
 * closest word for the user specified vector.
 * 
 * @author Nikit
 *
 */
public class NrmlMemModelUnitVecExtItr extends NrmlMemModelBinSrch {
	...
	public NrmlMemModelUnitVecExtItr(final Map<String, float[]> embdngMap, final int vectorSize, int bucketCount) throws IOException {
